const LoginForm = () => {
    return ( 
        <div className="w-[300px] flex flex-col py-10">
            ...
            <div className="bg-[#181818] rounded py-2 px-2 mb-4">
                ...
                <input type="text" id="email" className="bg-transparent text-gray-300 w-full outline-none px-3 py-2 duration-150 text-sm" placeholder="Email"/>
            </div>
            ...
            <button className="bg-mainColor hover:bg-mainHover py-4 text-white mt-4 duration-200 rounded">Login</button>
